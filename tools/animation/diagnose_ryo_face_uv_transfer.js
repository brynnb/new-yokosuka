...
function usage() {
    console.error([
        "Usage: node tools/animation/diagnose_ryo_face_uv_transfer.js --body <body.MT5> --face <face.MT5> [options]",
        "",
        "Options:",
        "  --out <json>             Write report JSON. Default: .disc-work/analysis/ryo-face-uv-transfer-diagnostic.json",
...
function parseArgs(argv) {
    const args = {
        ...
        face: ".disc-work/analysis/pc-sm1-ryo/SCENE/03/MODEL/FACE/YKG_F.MT5",
        out: ".disc-work/analysis/ryo-face-uv-transfer-diagnostic.json",
        attachNode: 0xd648,
        compose: "face-node",
        maxDistance: 0.035,
        normalWeight: 0.015,
