...
function printUsage() {
    console.error("Usage: node tools/animation/dump_motn.js <motion.bin> [--filter PATTERN] [--limit N] [--json] [--curves]");
}
...
function compactSequence(sequence, includeCurves = false) {
    return {
        ...
        controllerFamilyFlags: sequence.controllerFamilyFlags,
