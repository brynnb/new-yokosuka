...
function usage() {
    console.error([
        "Usage: node tools/animation/dump_face_ftbl.js <file_FTBL.BIN|face-dir> [--model file_F.MT5] [--json] [--limit N]",
        "",
...
function summarizePcStaticInterpretation(report) {
    ...
    return {
        ...
        viewerImplication: "Attach *_F.MT5 at the body's signed -67 FACE node and use *_FTBL.BIN as weighted face controls; FTBL is not UV data and the face model is not a standalone character.",
    };
}
