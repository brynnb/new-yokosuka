...
# Python 2/3 conversion by Ricardo Mendonça Ferreira.
# See tools/licenses/iso9660_license.txt for the upstream permission grant.
import struct
import sys
from   io import BytesIO

if sys.version_info[0] < 3:
      from urllib         import FancyURLopener as URLopener
else:
