...
Usage:
  python3 -m tools.assets.convert_sky_textures            # Convert all air*.pvr
  python3 -m tools.assets.convert_sky_textures air00.pvr  # Convert specific files
"""

import sys
import os
from tools.assets.pvr_decoder import convert_pvr_to_png
...
def main():
    ...
    pvr_dir = os.path.join(tools_dir, "extracted_tex")
