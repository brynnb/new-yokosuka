...
const DEFAULT_ROOT = (
  process.env.SHENMUE_PC_ARCHIVE_ROOT
  || ".disc-work/pc-sm1-extracted/archives/dx11/data"
);

function usage() {
    console.error([
        "Usage: node tools/assets/extract_pc_tac.js [options]",
        "",
        "Options:",
        ...
        "",
        "Examples:",
        "  node tools/assets/extract_pc_tac.js --archive disk --filter 'YKB|YKC|MOTION'",
        "  node tools/assets/extract_pc_tac.js --archive disk --filter 'YKB_M|YKC_M' --extract --out .disc-work/analysis/pc-sm1",
    ].join("\n"));
}
